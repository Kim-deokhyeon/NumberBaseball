...
void main() {
  ...
  group('심판 테스트 : ', () {
    test('각 입력에 대해 판단을 내릴 수 있어야 한다.', () {
      expect(referee.judge(round).runtimeType == Result, true);

      expect(
          referee.judge(round.copyWith(
                answer: Answer(initAnswer: [6, 4, 2]),
              )) ==
      ...
      expect(
          referee.judge(
                round.copyWith(
                  answer: Answer(initAnswer: [7, 6, 3]),
                ),
              ) ==
      ...
      expect(
          referee.judge(
                round.copyWith(
                  answer: Answer(initAnswer: [3, 5, 4]),
                ),
              ) ==
      ...
      expect(
          referee.judge(
                round.copyWith(
                  answer: Answer(initAnswer: [3, 6, 7]),
                ),
              ) ==
